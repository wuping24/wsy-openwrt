...
git clone https://github.com/kenzok8/openwrt-packages.git  lede/package ##下载kenzok8/openwrt-packages的源代码 和 passwall依赖库kenzok8/small.git。
git clone https://github.com/kenzok8/small.git lede/package
