...
rm -rf ./package/lean/luci--app-jd-dailybonu && git clone -b https://github.com/jerrykuku/luci-app-jd-dailybonus.git package/lean/luci-app-jd-dailybonu  #京东签到
git clone https://github.com/liuran001/openwrt-packages/tree/packages/luci-app-dockerman.git package/lean/luci-app-dockerman
